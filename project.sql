...
create database dynamicbiz_security;
...
CREATE DATABASE IF NOT EXISTS dynamicbiz_security CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;

CREATE USER IF NOT EXISTS 'dynamicbiz_user'@'localhost' IDENTIFIED BY '2003';
ALTER USER 'dynamicbiz_user'@'localhost' IDENTIFIED WITH mysql_native_password BY '2003';
GRANT ALL PRIVILEGES ON dynamicbiz_security.* TO 'dynamicbiz_user'@'localhost';
FLUSH PRIVILEGES;